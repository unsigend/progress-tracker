...
// import types
import type { EmailCheckResponseDto, CreateUserDto } from "@/api/api";
        ...
        if (currentStep < steps.length) {
            ...
            if (currentField === "email") {
                if (!validationUtils.email(formData.email || "")) {
                    toast.error(ERROR_MESSAGES.EMAIL_ERROR_MESSAGE);
                    return;
                }
                ...
                if (!validationUtils.password(formData.password || "")) {
                    toast.error(ERROR_MESSAGES.PASSWORD_ERROR_MESSAGE);
                    return;
                }
            } else if (currentField === "name") {
                if (!validationUtils.username(formData.name || "")) {
                    toast.error(ERROR_MESSAGES.USERNAME_ERROR_MESSAGE);
                    return;
                }
            }
            // move to next step
